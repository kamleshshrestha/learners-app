...
The core learner flow is implemented end to end for four concepts (gradient descent, backpropagation, overfitting and train/test split); the other concepts show a "coming soon" state until they have questions and misconceptions in `lib/learning/`. Unit tests run with Vitest.

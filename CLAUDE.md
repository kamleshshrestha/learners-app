...
The core learner flow is implemented end to end for five concepts (gradient descent, backpropagation, overfitting, train/test split and linear regression); the other concepts show a "coming soon" state until they have questions and misconceptions in `lib/learning/`. Unit tests run with Vitest.
